...
public class AssignIncident extends ServiceNowBase{
	...
	public void runAssignIncident(String activity) throws InterruptedException {
		...
		shadow.findElementByXPath("//div[@id='single-input-journal-entry']//following::textarea[@id='activity-stream-textarea']").sendKeys(activity);
